...
// Usage:
//   REGION_SLUG=veneto REGION_ISO=IT-34 node scripts/build_pois_family_it_region.mjs
//
// Output:
...
function buildQuery(regionIso) {
  // FAMILY: parchi divertimento, acquapark, zoo/acquari, parchi avventura,
  // musei kids/science center, playground (solo se con nome).
