...
(() => {
  ...
  function shortWhatIs(place, categoryUI) {
    ...
    if (category === "family") return "Family • attività adatte anche ai bambini (verifica orari).";
  ...
  function bindResultAreaDelegation() {
    ...
    area.addEventListener("click", (e) => {
      ...
      if (moreBtn) {
        ...
        VISIBLE_ALTS = Math.min(maxAlts, VISIBLE_ALTS + CFG.ALTS_PAGE);
  ...
  async function runSearch({ silent = false, forbidPid = null } = {}) {
    ...
    try {
      ...
      // ✅ Eventi: delega a events.js (bridge)
      if (cat === "eventi") {
