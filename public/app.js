...
const et = getEventType();
const ew = getEventWhen();
area.innerHTML =   <div class="card clickSafe" style="box-shadow:none; border-color:rgba(0,224,255,.25); background:rgba(0,224,255,.06);">   <div style="font-weight:950; font-size:18px;">🎉 Eventi (in arrivo)</div>   <div class="small muted" style="margin-top:8px; line-height:1.45;">   Subfiltri selezionati: <b>${escapeHtml(et)}</b> • <b>${escapeHtml(ew)}</b><br>   Nel prossimo step aggiungiamo il dataset eventi offline + workflow di aggiornamento.   </div>   </div>  ;
